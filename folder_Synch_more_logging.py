...
#A python logging library was not used due to inconsistencies in output, either randomly duplicating or skipping outputs, as such print/file.write was used.
